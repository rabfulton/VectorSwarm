...
- `powerup.double_shot_r` float (`0..1`)
- `powerup.double_shot_g` float (`0..1`)
- `powerup.double_shot_b` float (`0..1`)
- `powerup.triple_shot_r` float (`0..1`)
- `powerup.triple_shot_g` float (`0..1`)
- `powerup.triple_shot_b` float (`0..1`)
- `powerup.vitality_r` float (`0..1`)
- `powerup.vitality_g` float (`0..1`)
- `powerup.vitality_b` float (`0..1`)
- `powerup.orbital_boost_r` float (`0..1`)
- `powerup.orbital_boost_g` float (`0..1`)
- `powerup.orbital_boost_b` float (`0..1`)
- `powerup.magnet_r` float (`0..1`)
- `powerup.magnet_g` float (`0..1`)
- `powerup.magnet_b` float (`0..1`)
