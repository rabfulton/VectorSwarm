...
static int compare_levels_semantic(const char* ctx, const leveldef_level* a, const leveldef_level* b) {
    ...
    CMP_FLOAT_FIELD(ctx, a, b, forest_spore_density);
    CMP_FLOAT_FIELD(ctx, a, b, forest_spore_scale);
    CMP_FLOAT_FIELD(ctx, a, b, forest_spore_drift_speed);
    CMP_FLOAT_FIELD(ctx, a, b, forest_haze_alpha);
    CMP_FLOAT_FIELD(ctx, a, b, forest_canopy_density);
    CMP_FLOAT_FIELD(ctx, a, b, forest_parallax_strength);
    CMP_FLOAT_FIELD(ctx, a, b, forest_flora_density);
    CMP_FLOAT_FIELD(ctx, a, b, forest_branch_wobble_amp);
    CMP_FLOAT_FIELD(ctx, a, b, forest_branch_wobble_speed);
    CMP_FLOAT_FIELD(ctx, a, b, forest_membrane_glow);
    CMP_FLOAT_FIELD(ctx, a, b, forest_biolume_pulse_freq);
