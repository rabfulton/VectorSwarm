...
enum level_editor_marker_kind {
    ...
    LEVEL_EDITOR_MARKER_BOID_ORBITAL = 18,
...
typedef struct level_editor_state {
    ...
    leveldef_curated_combat_tuning level_curated_combat;
    ...
    leveldef_curated_combat_tuning snapshot_level_curated_combat;
...
enum {
    LEVEL_EDITOR_PROP_FIRST = 0,
    LEVEL_EDITOR_LEVEL_PROP_WAVE_MODE = 0,
...
enum {
    LEVEL_EDITOR_WAVE_PROP_TYPE = 0
};

enum {
    LEVEL_EDITOR_CURATED_FORMATION_PROP_FIRE_PROB_MUL = 0,
    LEVEL_EDITOR_CURATED_FORMATION_PROP_COOLDOWN_MUL = 1,
    LEVEL_EDITOR_CURATED_FORMATION_PROP_SHOT_COUNT = 2,
    LEVEL_EDITOR_CURATED_FORMATION_PROP_AIM_ERROR_MUL = 3,
    LEVEL_EDITOR_CURATED_FORMATION_PROP_PROJECTILE_SPEED_MUL = 4,
    LEVEL_EDITOR_CURATED_FORMATION_PROP_SPREAD_MUL = 5
};

enum {
    LEVEL_EDITOR_CURATED_SWARM_PROP_FIRE_PROB_MUL = 0,
    LEVEL_EDITOR_CURATED_SWARM_PROP_SPREAD_PROB_MUL = 1,
    LEVEL_EDITOR_CURATED_SWARM_PROP_COOLDOWN_MUL = 2,
    LEVEL_EDITOR_CURATED_SWARM_PROP_SHOT_COUNT = 3,
    LEVEL_EDITOR_CURATED_SWARM_PROP_AIM_ERROR_MUL = 4,
    LEVEL_EDITOR_CURATED_SWARM_PROP_PROJECTILE_SPEED_MUL = 5,
    LEVEL_EDITOR_CURATED_SWARM_PROP_SPREAD_MUL = 6
};

enum {
    LEVEL_EDITOR_CURATED_KAMIKAZE_PROP_FIRE_PROB_MUL = 0,
    LEVEL_EDITOR_CURATED_KAMIKAZE_PROP_SPEED_MUL = 1,
    LEVEL_EDITOR_CURATED_KAMIKAZE_PROP_ACCEL_MUL = 2
};

enum {
    LEVEL_EDITOR_CURATED_MANTA_PROP_FIRE_PROB_MUL = 0,
    LEVEL_EDITOR_CURATED_MANTA_PROP_MISSILE_COUNT_BONUS = 1,
    LEVEL_EDITOR_CURATED_MANTA_PROP_MISSILE_COOLDOWN_MUL = 2,
    LEVEL_EDITOR_CURATED_MANTA_PROP_MISSILE_CHARGE_MUL = 3
};

enum {
    LEVEL_EDITOR_CURATED_EEL_PROP_FIRE_PROB_MUL = 0,
    LEVEL_EDITOR_CURATED_EEL_PROP_ARC_FIRE_RATE_MUL = 1,
    LEVEL_EDITOR_CURATED_EEL_PROP_ARC_DURATION_MUL = 2,
    LEVEL_EDITOR_CURATED_EEL_PROP_ARC_RANGE_MUL = 3,
    LEVEL_EDITOR_CURATED_EEL_PROP_ARC_DAMAGE_INTERVAL_MUL = 4
};

enum {
    LEVEL_EDITOR_WAVE_SINE_PROP_FORMATION_FIRE_PROB_MUL = 7,
    LEVEL_EDITOR_WAVE_SINE_PROP_FORMATION_COOLDOWN_MUL = 8,
    LEVEL_EDITOR_WAVE_SINE_PROP_FORMATION_SHOT_COUNT = 9,
    LEVEL_EDITOR_WAVE_SINE_PROP_FORMATION_AIM_ERROR_MUL = 10,
    LEVEL_EDITOR_WAVE_SINE_PROP_FORMATION_PROJECTILE_SPEED_MUL = 11,
    LEVEL_EDITOR_WAVE_SINE_PROP_FORMATION_SPREAD_MUL = 12
};

enum {
    LEVEL_EDITOR_BOID_PROP_SIZE_SCALE = 7,
    LEVEL_EDITOR_BOID_PROP_DELAY_S = 8,
    LEVEL_EDITOR_BOID_PROP_SWARM_FIRE_PROB_MUL = 9,
    LEVEL_EDITOR_BOID_PROP_SWARM_SPREAD_PROB_MUL = 10,
    LEVEL_EDITOR_BOID_PROP_SWARM_COOLDOWN_MUL = 11,
    LEVEL_EDITOR_BOID_PROP_SWARM_SHOT_COUNT = 12,
    LEVEL_EDITOR_BOID_PROP_SWARM_AIM_ERROR_MUL = 13,
    LEVEL_EDITOR_BOID_PROP_SWARM_PROJECTILE_SPEED_MUL = 14,
    LEVEL_EDITOR_BOID_PROP_SWARM_SPREAD_MUL = 15
};

enum {
    LEVEL_EDITOR_WAVE_KAMIKAZE_PROP_DELAY_S = 9,
    LEVEL_EDITOR_WAVE_KAMIKAZE_PROP_FIRE_PROB_MUL = 10,
    LEVEL_EDITOR_WAVE_KAMIKAZE_PROP_SPEED_MUL = 11,
    LEVEL_EDITOR_WAVE_KAMIKAZE_PROP_ACCEL_MUL = 12
};

enum {
    LEVEL_EDITOR_MANTA_WING_PROP_DELAY_S = 6,
    LEVEL_EDITOR_MANTA_WING_PROP_FIRE_PROB_MUL = 7,
    LEVEL_EDITOR_MANTA_WING_PROP_MISSILE_COUNT_BONUS = 8,
    LEVEL_EDITOR_MANTA_WING_PROP_MISSILE_COOLDOWN_MUL = 9,
    LEVEL_EDITOR_MANTA_WING_PROP_MISSILE_CHARGE_MUL = 10
};

enum {
    LEVEL_EDITOR_EEL_SWARM_PROP_DELAY_S = 7,
    LEVEL_EDITOR_EEL_SWARM_PROP_FIRE_PROB_MUL = 8,
    LEVEL_EDITOR_EEL_SWARM_PROP_ARC_FIRE_RATE_MUL = 9,
    LEVEL_EDITOR_EEL_SWARM_PROP_ARC_DURATION_MUL = 10,
    LEVEL_EDITOR_EEL_SWARM_PROP_ARC_RANGE_MUL = 11,
    LEVEL_EDITOR_EEL_SWARM_PROP_ARC_DAMAGE_INTERVAL_MUL = 12
};
