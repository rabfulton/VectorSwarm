...
#define VIDEO_QUALITY_MAX 3
#define VIDEO_QUALITY_COUNT 4
...
typedef struct render_metrics {
    ...
    int level_editor_texture_tile_w_px;
    int level_editor_texture_tile_h_px;
    int level_editor_texture_panel_w_units;
    int level_editor_texture_panel_h_units;
    ...
    float level_editor_event_wave_spawn_timeout_factor;
...
typedef struct sphere_render_debug_stats {
    ...
    int degree3_count;
    int degree4p_count;
    float max_quantized_merge_gap;
    float spring_peak_disp;
    float spring_peak_vel;
    float spring_impulse;
} sphere_render_debug_stats;
